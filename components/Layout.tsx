          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li><Link to="/chatbot" className="text-base text-gray-400 hover:text-white transition-colors" onClick={handleNavigation}>PANASA Bot</Link></li>
              </ul>
            </div>
          </div>
