...
import { 
  ...
  africanGames2024Images,
  presidentsCupAYSC2023Images,
  asc2024Images
} from './GalleryPage';

type CollectionType = 'kpalime' | 'uganda' | 'presidentsCup' | 'kenya' | 'liberia' | 'pressConference' | 'africanGames2024' | 'presidentsCupAYSC2023' | 'asc2024' | 'all';
...
const collectionData: Record<CollectionType, CollectionInfo> = {
  all: {
    ...
    images: [...kpalimeImages, ...ugTrophyTourImages, ...presidentsCupImages, ...kenyaTrophyTourImages, ...liberiaTrophyTourImages, ...pressConferenceTogoImages, ...africanGames2024Images, ...presidentsCupAYSC2023Images, ...asc2024Images]
  ...
  africanGames2024: {
    title: 'African Games (Accra 2024)',
    description: 'Scrabble events and competitions at the African Games in Accra, Ghana 2024.',
    images: africanGames2024Images.filter(img => img.src && img.src.trim() !== ''),
    bgColor: 'from-purple-500/20 to-purple-600/20',
    textColor: 'text-purple-400',
    borderColor: 'border-purple-400/30'
  },
  presidentsCupAYSC2023: {
    title: 'President\'s Cup and AYSC 2023',
    description: 'President\'s Cup and African Youth Scrabble Championship events from 2023.',
    images: presidentsCupAYSC2023Images.filter(img => img.src && img.src.trim() !== ''),
    bgColor: 'from-orange-500/20 to-orange-600/20',
    textColor: 'text-orange-400',
    borderColor: 'border-orange-400/30'
  },
  asc2024: {
    title: 'Africa Scrabble Championship - Kigali 2024',
    description: 'Africa Scrabble Championship held in Kigali, Rwanda in 2024.',
    images: asc2024Images.filter(img => img.src && img.src.trim() !== ''),
    bgColor: 'from-green-500/20 to-green-600/20',
